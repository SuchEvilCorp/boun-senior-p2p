...
const mlkManifesto = `I am happy to join with you today in what will go down in history as the greatest demonstration for freedom in the history of our nation.
...
const node = new PFS({ repo: 'peery' })
node.once('ready', () => {
  console.log('PFS node is ready');
  node.add(PFS.Buffer.from(mlkManifesto), (err, files) => {
    console.log('Uploaded a file to the system:', files[0]);
  });
  node.cat("QmRDJbixMYudepaEb87AeRjtSh3C9LNx7gWzn4oFSSs9xN", (err, data) => {
